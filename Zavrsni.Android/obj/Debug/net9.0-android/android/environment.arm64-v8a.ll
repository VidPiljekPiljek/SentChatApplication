...
@dso_apk_entries = dso_local local_unnamed_addr global [16 x %struct.DSOApkEntry] zeroinitializer, align 8
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [24 x i8] c"com.CompanyName.Zavrsni\00", align 1

;DSOCacheEntry
@.DSOCacheEntry.0_name = private unnamed_addr constant [21 x i8] c"libsentry-android.so\00", align 1
...
@.DSOCacheEntry.14_name = private unnamed_addr constant [20 x i8] c"libHarfBuzzSharp.so\00", align 1
@.DSOCacheEntry.15_name = private unnamed_addr constant [16 x i8] c"libSkiaSharp.so\00", align 1
