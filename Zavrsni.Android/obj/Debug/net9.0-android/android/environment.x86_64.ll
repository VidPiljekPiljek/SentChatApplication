...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 306, ; uint32_t number_of_assemblies_in_apk
	i32 68, ; uint32_t bundled_assembly_name_width
	i32 64, ; uint32_t number_of_dso_cache_entries
	i32 0, ; uint32_t number_of_aot_cache_entries
	i32 16, ; uint32_t number_of_shared_libraries
...
; DSO cache entries
@dso_cache = dso_local local_unnamed_addr global [64 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.14_name, ; name: libHarfBuzzSharp.so
		ptr null; void* handle
	}, ; 3
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.15_name, ; name: libSkiaSharp.so
		ptr null; void* handle
	}, ; 7
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.1_name, ; name: libsentry.so
		ptr null; void* handle
	}, ; 16
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.0_name, ; name: libsentry-android.so
		ptr null; void* handle
	}, ; 26
	%struct.DSOCacheEntry {
...
@dso_apk_entries = dso_local local_unnamed_addr global [16 x %struct.DSOApkEntry] zeroinitializer, align 16
...
@bundled_assemblies = dso_local local_unnamed_addr global [306 x %struct.XamarinAndroidBundledAssembly] [
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [24 x i8] c"com.CompanyName.Zavrsni\00", align 16

;DSOCacheEntry
@.DSOCacheEntry.0_name = private unnamed_addr constant [21 x i8] c"libsentry-android.so\00", align 16
@.DSOCacheEntry.1_name = private unnamed_addr constant [13 x i8] c"libsentry.so\00", align 1
...
@.DSOCacheEntry.14_name = private unnamed_addr constant [20 x i8] c"libHarfBuzzSharp.so\00", align 16
@.DSOCacheEntry.15_name = private unnamed_addr constant [16 x i8] c"libSkiaSharp.so\00", align 16
